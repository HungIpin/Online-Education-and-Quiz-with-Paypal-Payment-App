# Online Education and Quiz with Paypal Payment App
### Các công nghệ chính:
...
### Lưu ý cài đặt
 ...
 - Với project React Native khi mở lần đầu tiên cần sử dụng lệnh ```npm install``` để đảm bảo cài đặt đầy đủ dependencies, kiểm tra xem file nodemodule đã tồn tại hay chưa
...
## Cảm ơn trung tâm Cybersoft đã hướng dẫn nhiệt tính trong thời gian học và đặc biệt cảm ơn anh Đạt đã giúp đỡ hết mình lúc em gặp khó khăn. Đây là project em đã bảo vệ thành công ở trường ( mục tiêu ban đầu đặt ra khi tham gia học ở trung tâm), em xin phép lấy nộp cho bài cuối kỳ ở trung tâm
